...
import jpa.session.CountryFacade;
...
public class CountryController implements Serializable {
    ...
    @EJB
    private jpa.session.CountryFacade ejbFacade;
    ...
    public String setParam(Country country){
        
        selected=new Country(country.getCountryID(),country.getCountryName(),country.getCountrycode());
       
        return "countryEdit.xhtml";
    }

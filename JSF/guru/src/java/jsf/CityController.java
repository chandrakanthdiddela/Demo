...
public class CityController implements Serializable {
    ...
    @EJB
    private jpa.session.CityFacade ejbFacade;
    ...
    public CityController() {
     ...
     public String setParam(City city){
        
        selected=new City(city.getCityID(),city.getLatitude(),city.getLongitude(),city.getName(),city.getCountryName());
       
        return "cityEdit.xhtml";
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("CityCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("CityUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("CityDeleted"));
        if (!JsfUtil.isValidationFailed()) {

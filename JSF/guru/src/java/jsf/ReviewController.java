...
import jpa.session.ReviewFacade;
...
public class ReviewController implements Serializable {
    ...
    @EJB
    private jpa.session.ReviewFacade ejbFacade;
    ...
    public String setParam(Review review){
        
        selected=new Review(review.getReviewid(),review.getDescription(),review.getDate(),review.getRating());
        return "reviewEdit.xhtml";
    }

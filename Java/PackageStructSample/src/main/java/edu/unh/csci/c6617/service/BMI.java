...
public class BMI {
	...
	public BMI(double pdlbWeight, double pdlbHeight) {
	...
	public void recommendedWeeks(double ldlbBMI) {
		try {
			if (ldlbBMI == 0) {
				throw new BMIZeroException("ldlbBMI cannot be zero");
			...
			System.out.println("Exception occured in Recommend BMI method");
			System.exit(0);
		}

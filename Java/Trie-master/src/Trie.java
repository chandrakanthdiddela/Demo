...
public  static List<String> GetWords() throws IOException
{
     ...
     String[] lstrwordlist={};
    ArrayList<String> lobjlist = new ArrayList<String>();
        PdfReader reader = new PdfReader("testfilewith1000words.pdf");
            ...
            String page = PdfTextExtractor.getTextFromPage(reader, i+1);
             lstrwordlist= page.trim().split("\n");
                ...
                {
                   // lettercounts=lstrwordlist[j].trim().length();
                    lobjlist.add(lstrwordlist[j].trim());
...
//			}
    ...
    public static void main(String[] args) throws IOException
    {
            ...
            // Create a Trie with root '#'
           //System.out.println("size of trie"+ trie.children.length);
            ...
            do{
                 ...
                 System.out.println("\nEnter the choice of operation: \n 1)Insert into Trie \n "
                    ...
                    + "4)Print all words in Trie \n 5)Quit \n 6)lettercount \n 7) number of words in pdf document\n 8) Size of Tire");
                ...
                switch(choice){
                    ...
                    case 1:
                        ...
                        // will read the file and return list
                       List<String> wordarray= Trie.GetWords();
                       wordcount=wordarray.size();
                       for (int i=0;i<wordarray.size();i++)
                       {
                           lettercounts=lettercounts+wordarray.get(i).length();
                           insertWord(trie, wordarray.get(i));
                    ...
                    case 2:
                     ...
                     case 5:
                        System.exit(0);
                         case 6:
                         System.out.println("Number Of letters in the document:"+lettercounts );
                             break;
                              case 7:
                                  
                         System.out.println("Number Of wordarray1 in the document:"+wordcount );

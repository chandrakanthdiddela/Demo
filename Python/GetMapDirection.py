...
try:
  ...
  #Source=sys.argv[1]
  Source="ForestRd"
  destination="UniversityofNewHaven"
  #destination=sys.argv[1]
except ValueError:
    print("Error in command line arguments")
apicode = "AIzaSyD5Fqole2qOY6R9j5vJ-shLZY2ZYAlvAEE"
#urlquery="http://maps.googleapis.com/maps/api/directions/json?origin=Jackson+Av&destination=Prospect+Av"+"&APPID="+apicode
urlquery="http://maps.googleapis.com/maps/api/directions/json?origin="+Source+"&destination="+destination+"&APPID="+apicode
